...
var $popover = $('.popover'), $lottery = $('#lotterys'), $go = $('#go'), $modal = $('.popover,.modal'), $lottery_num = $('#lottery_num'), total_num = getCookie('LOTTERY_TOTAL_NUM') || 570;
...
function lottery(){
	...
	$modal.hide();
	if(total_num <= 0){
		// $popover.show().find('.m3').show(); //取消分享朋友圈
		total_num = 0;
	}else{
...
$(function(){
	...
	//动态添加大转盘的奖品与奖品区域背景颜色
	_lottery.title = ["特等奖", "一等奖", "二等奖", "谢谢参与", "三等奖", "谢谢参与", "幸运奖 ", "谢谢参与"];
